...
mysqlfailover = /usr/bin/mysqlfailover
log        = /bd/mylog/mysqld_multi.log

#pid-file   = /bd/mybd1/mysqlq.pid
# user       = multi_admin
# password   = secret
